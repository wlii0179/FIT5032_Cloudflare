...
const validateReason = () => {
  // 检查 reason 字段是否包含 friend（不区分大小写）
  showFriendMessage.value = /friend/i.test(formData.value.reason)
}
</script>
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <div v-if="showFriendMessage" style="color: #42b883; font-weight: bold;">
